...
if input_option == "Manual Input":
    ...
    with col3:
        offer_type_bogo = st.number_input('Number of Offer Type BOGO: ', min_value=0, step=1)
        offer_type_discount = st.number_input('Number of Offer Type Discount: ', min_value=0, step=1)
        offer_type_informational = st.number_input('Number of Offer Type Informational: ', min_value=0, step=1)
